...
**To adhere to this best practice:** Include a benchmark or validation dataset for the public health bioinformatics pipeline to promite transparency and consistency in the evaluation and comparison of different tools. 
